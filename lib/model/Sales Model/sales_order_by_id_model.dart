...
SalesOrderByIdModel salesOrderByIdModelFromJson(String str) => SalesOrderByIdModel.fromJson(json.decode(str));

String salesOrderByIdModelToJson(SalesOrderByIdModel data) => json.encode(data.toJson());
...
class SalesOrderByIdModel {
    ...
    factory SalesOrderByIdModel.fromJson(Map<String, dynamic> json) => SalesOrderByIdModel(
        result: json["result"],
...
class Header {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "ExpDeliveryDate": expDeliveryDate == null ? null : expDeliveryDate!.toIso8601String(),
